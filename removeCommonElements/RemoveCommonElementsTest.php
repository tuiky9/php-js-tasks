...
require_once __DIR__ . '/php/remove_common_elements.php';
...
final class RemoveCommonElementsTest extends TestCase
{
    ...
    {
        self::assertSame($expected, $this->solution->removeCommonElements($list1, $list2));
    }
    ...
    public function testInputListsNotMutated(): void
    {
        ...
        $this->solution->removeCommonElements($list1, $list2);
