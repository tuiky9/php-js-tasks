...
final class DeepMergeTest extends TestCase
{
    ...
    {
        self::assertSame($expected, Solution::solution($left, $right));
    }
    ...
    public function testNestedLeftNotMutatedViaResult(): void
    {
        ...
        $result = Solution::solution($left, ['nested' => ['added' => 2]]);
