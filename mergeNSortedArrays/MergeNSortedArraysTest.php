...
require_once __DIR__ . '/php/merge_n_sorted_arrays.php';
...
final class MergeNSortedArraysTest extends TestCase
{
    ...
    {
        self::assertSame($expected, Solution::mergeNSortedArrays($input));
    }
    ...
    {
        self::assertSame([], Solution::mergeNSortedArrays([]));
    }
}
