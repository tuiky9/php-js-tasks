...
require_once __DIR__ . '/php/is_toeplitz_matrix.php';
...
final class ToeplitzMatrixTest extends TestCase
{
    public function testCase1(): void
    {
        ...
        $this->assertEquals(true, $solution->isToeplitzMatrix($matrix));
    }
    ...
    public function testCase2(): void
    {
        ...
        $this->assertEquals(false, $solution->isToeplitzMatrix($matrix));
    }
